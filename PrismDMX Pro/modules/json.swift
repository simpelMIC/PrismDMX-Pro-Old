...
class fixtureTemplateJson {
    func encode(fixtureTemplate: fixtureTemplate) -> String {
    ...
    func decode(input: String) -> fixtureTemplate {
...
class fixturesJson {
    func encode(fixtures: fixtures) -> String {
        let jsonEncoder = JSONEncoder()
    ...
    func decode(input: String) -> fixtures {
        let jsonDecoder = JSONDecoder()
